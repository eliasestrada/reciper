...
class GeneralRequestTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->name_min = config('validation.settings.name.min');
        $this->name_max = config('validation.settings.name.max');
        $this->about_me_max = config('validation.settings.about_me.max');
