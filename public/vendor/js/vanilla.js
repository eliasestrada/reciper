...
var imageUploader = {
    ...
    showImage: function showImage() {
        ...
        this.src.addEventListener("change", function () {
            if (_this20.src.files.length !== 0) {
                var that = _this20;
                _this20.fr.readAsDataURL(_this20.src.files[0]);
                _this20.fr.onload = function (e) {
                    that.target.src = this.result;
                };
            } else {
                _this20.target.src = "/storage/recipes/default.jpg";
            }
        });
    }
};
...
if ($("collapsible-li-tag") && window.innerWidth > 600) {
    setTimeout(function () {
        document.querySelector("#collapsible-li-tag .collapsible-body").setAttribute("style", "display:block");
