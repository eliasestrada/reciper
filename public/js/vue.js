...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_core_js__ = __webpack_require__(133);
...
window.Vue = __webpack_require__(344);

var components = ['Recipes', 'RandomRecipesSidebar', 'DeleteRecipeBtn', 'CategoriesField', 'Like'];

components.forEach(function (comp) {
	Vue.component(comp, __webpack_require__(348)("./" + comp + '.vue'));
});
...
var core = __webpack_require__(11);
var $export = __webpack_require__(0);
var partial = __webpack_require__(128);
...
$export($export.P + $export.F, 'Function', { part: __webpack_require__(128) });
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(95)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(95)(/&(?:amp|lt|gt|quot|apos);/g, {
  '&amp;': '&',
  '&lt;': '<',
  '&gt;': '>',
  '&quot;': '"',
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(96), __webpack_require__(345).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(96), __webpack_require__(347)))
...
var map = {
	"./CategoriesField.vue": 349,
	"./DeleteRecipeBtn.vue": 352,
	"./Like.vue": 355,
	"./RandomRecipesSidebar.vue": 358,
	"./Recipes.vue": 361
};
...
Component.options.__file = "resources\\assets\\js\\vue\\components\\CategoriesField.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0fb114ad", Component.options)
  } else {
    hotAPI.reload("data-v-0fb114ad", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		fetchCategories: function fetchCategories() {
			...
			fetch('/api/recipes/other/categories').then(function (res) {
				return res.json();
			}).then(function (data) {
    ...
    [
      ...
      _c("h6", { staticClass: "col s12 center-align mb-2" }, [
        _c(
          "a",
          {
            staticClass: "add-remove-field ml-2",
            ...
            _c(
              ...
              [
                _vm.recipeCategories && _vm.recipeCategories.length > 0
                  ? _c(
                      ...
                      [
                        _vm._v(
                          "\n\t\t\t\t\t" +
                            _vm._s(
                              _vm.recipeCategories[i]["name_" + _vm.locale]
                            ) +
                            "\n\t\t\t\t"
                        )
                      ]
                  ...
                  : _vm._e(),
                _vm._v(" "),
                _vm._l(_vm.categories, function(categ) {
                  return _c(
                    "option",
                    { key: categ["id"], domProps: { value: categ["id"] } },
                    [
                      _vm._v(
                        "\n\t\t\t\t\t" +
                          _vm._s(categ["name_" + _vm.locale]) +
                          "\n\t\t\t\t"
                      )
                    ]
                  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0fb114ad", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\vue\\components\\DeleteRecipeBtn.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0a6e7672", Component.options)
  } else {
    hotAPI.reload("data-v-0a6e7672", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
		...
		deleteRecipe: function deleteRecipe() {
			...
			if (confirm(this.confirm)) {
				fetch('/api/recipes/' + this.recipeId, {
					...
					data === 'success' ? window.location.href = '/users/other/my-recipes' : _this.error = _this.deletedFail;
    ...
    _vm.error
      ...
      : _c("span", [
          _c(
            "button",
            {
              staticClass: "btn-floating red btn-large",
              attrs: { title: _vm.deleting, type: "button" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0a6e7672", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\vue\\components\\Like.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6f30eb90", Component.options)
  } else {
    hotAPI.reload("data-v-6f30eb90", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		fetchVisitorLikes: function fetchVisitorLikes() {
			var _this = this;
			...
			fetch('/api/recipes/other/check-if-liked/' + this.recipeId, {
				...
				return _this.changeLikeButton(data);
			}).catch(function (err) {
				return console.log(err);
			});
		},
		changeLikeButton: function changeLikeButton(value) {
			this.liked = value == 0 ? false : true;
		},
		changeLikeNumber: function changeLikeNumber(value) {
			value == 0 ? this.allLikes-- : this.allLikes++;
		},
		giveLikeOrDislike: function giveLikeOrDislike() {
			var _this2 = this;
			...
			fetch('/api/recipes/other/' + state + '/' + this.recipeId, {
				...
				_this2.changeLikeButton(data.liked);
				_this2.changeLikeNumber(data.liked);
			}).catch(function (err) {
				return console.log(err);
			});
		}
        ...
        _c("a", {
          ...
          on: {
            click: function($event) {
              _vm.giveLikeOrDislike()
            }
          }
        }),
        _vm._v(" "),
        _c("i", [_vm._v(_vm._s(_vm.allLikes))])
      ]
    ],
    2
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6f30eb90", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		fetchData: function fetchData() {
			...
			fetch('/api/recipes/other/random/' + this.resipeId).then(function (res) {
				return res.json();
			}).then(function (res) {
    ...
    _vm._l(_vm.recipes, function(recipe) {
      return _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "card-content p-3" }, [
            _c("p", [_vm._v(_vm._s(recipe.title))])
          ])
        ]
      )
    })
...
Component.options.__file = "resources\\assets\\js\\vue\\components\\Recipes.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-78cad094", Component.options)
  } else {
    hotAPI.reload("data-v-78cad094", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		fetchRecipes: function fetchRecipes(page_url) {
			var _this = this;
...
var render = function() {
  ...
  return _c("div", [
        ...
        return _c("div", { key: recipe.id, staticClass: "col s12 m6 l3" }, [
          _c("div", { staticClass: "card" }, [
            ...
            _c("div", { staticClass: "card-content" }, [
              _c("span", { staticClass: "card-title activator" }, [
                _vm._v(
                  "\n\t\t\t\t\t\t" + _vm._s(recipe.title) + "\n\t\t\t\t\t\t"
                ),
    ...
    _vm._v(" "),
    _vm.pagin.prev_page_url || _vm.pagin.next_page_url
      ? _c("ul", { staticClass: "pagination" }, [
          _vm.pagin.prev_page_url
            ? _c("li", { staticClass: "page-item" }, [
                _c(
                  "a",
                  {
                    ...
                    on: {
                      click: function($event) {
                        _vm.fetchRecipes(_vm.pagin.prev_page_url)
                      }
                    }
                  },
                  [_vm._v("\n\t\t\t\t«\n\t\t\t")]
          ...
          _c("li", { staticClass: "page-item disabled" }, [
            _c("a", { staticClass: "page-link" }, [
              _vm._v(
                _vm._s(_vm.pagin.current_page) +
                  " / " +
                  _vm._s(_vm.pagin.last_page)
              )
            ])
          ]),
          _vm._v(" "),
          _vm.pagin.next_page_url
            ? _c("li", { staticClass: "page-item" }, [
                _c(
                  "a",
                  {
                    ...
                    on: {
                      click: function($event) {
                        _vm.fetchRecipes(_vm.pagin.next_page_url)
                      }
                    }
                  },
                  [_vm._v("\n\t\t\t\t»\n\t\t\t")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-78cad094", module.exports)
  }
}
