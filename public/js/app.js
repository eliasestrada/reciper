...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__main__ = __webpack_require__(8);
 ...
 * @return {void}
 */
/* harmony default export */ __webpack_exports__["a"] = (function (el, btn) {
    var customClass = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'active';

    var visible = false;

    __WEBPACK_IMPORTED_MODULE_0__main___default()(btn).addEventListener('click', function () {
        if (visible === false) {
            __WEBPACK_IMPORTED_MODULE_0__main___default()(el).classList.add(customClass);
            visible = true;
        } else if (visible === true) {
            __WEBPACK_IMPORTED_MODULE_0__main___default()(el).classList.remove(customClass);
            visible = false;
        }
    });
});
...
/* harmony default export */ __webpack_exports__["a"] = (function () {
    ...
    var images = document.querySelectorAll('img.lazy-load-img-vue');
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        fetchItems: function fetchItems() {
            ...
            this.$axios.post(this.url).then(function (data) {
                if (data.data != 'fail') {
                    _this.iconClass = data.data;
                    _this.playSoundEffect();
                    data.data == 'active' ? _this.amount++ : _this.amount--;
                }
            }).catch(function (err) {
                return console.error(err);
            });
        },
        playSoundEffect: function playSoundEffect() {
        ...
        toggleActive: function toggleActive() {
            if (this.userId) {
                var that = this;
                var checkIfAddedBefore = this.items.filter(function (item) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_vue__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vanilla_vanilla__ = __webpack_require__(214);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bootstrap__ = __webpack_require__(158);


window.Event = new Vue();

Vue.component('random-recipes-sidebar', __webpack_require__(180));
Vue.component('delete-recipe-btn', __webpack_require__(182));
Vue.component('categories-field', __webpack_require__(184));
Vue.component('list-item', __webpack_require__(187));
Vue.component('sort-buttons', __webpack_require__(190));
Vue.component('visibility', __webpack_require__(194));
Vue.component('btn-favs', __webpack_require__(196));
Vue.component('btn-like', __webpack_require__(199));
Vue.component('recipes', __webpack_require__(202));
Vue.component('tabs', __webpack_require__(208));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(12), __webpack_require__(160).setImmediate))
...
Component.options.__file = "resources/js/vue/components/RandomRecipesSidebar.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b82ffd08", Component.options)
  } else {
    hotAPI.reload("data-v-b82ffd08", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_lazyLoadImagesForVue__ = __webpack_require__(23);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchData: function fetchData() {
            ...
            this.$axios.get('/api/recipes-random/' + this.visitorId).then(function (res) {
                return _this.recipes = res.data.data;
            }).catch(function (err) {
                return console.error(err);
            });
        },
        runLazyLoadImagesForVue: function runLazyLoadImagesForVue(target) {
            Object(__WEBPACK_IMPORTED_MODULE_0__modules_lazyLoadImagesForVue__["a" /* default */])(target);
        }
    }
});
...
Component.options.__file = "resources/js/vue/components/DeleteRecipeBtn.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8bbebbde", Component.options)
  } else {
    hotAPI.reload("data-v-8bbebbde", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    methods: {
        deleteRecipe: function deleteRecipe() {
            ...
            if (confirm(this.confirm)) {
                this.$axios.delete('/recipes/' + this.recipeId).then(function (data) {
                    data.data === 'success' ? window.location.href = '/users/other/my-recipes' : _this.error = _this.deletedFail;
                }).catch(function (err) {
                    return console.error(err);
                });
            }
...
Component.options.__file = "resources/js/vue/components/CategoriesField.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-81397f68", Component.options)
  } else {
    hotAPI.reload("data-v-81397f68", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    props: ['add', 'label', 'select', 'deleting', 'recipeCategories', 'categories', 'categoriesTitle'],
    ...
    methods: {
        getFieldsFromProps: function getFieldsFromProps() {
        ...
        stableButtons: function stableButtons() {
            if (this.fields > 1) {
    ...
    computed: {
        classDelBtn: function classDelBtn() {
            return {
                disable: !this.visibleDelBtn
            };
        },
        classAddBtn: function classAddBtn() {
            return {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("h5", { staticClass: "col s12 center mb-1" }, [
        _vm._v(_vm._s(_vm.categoriesTitle) + " " + _vm._s(_vm.fields) + " / 4")
      ]),
      _vm._v(" "),
      _c("h6", { staticClass: "col s12 center mb-2" }, [
        _c(
          "a",
          {
            staticClass: "add-remove-field no-select ml-2 green-text",
            class: _vm.classAddBtn,
        ...
        _c(
          "a",
          {
            staticClass: "red-text no-select add-remove-field ml-2",
            class: _vm.classDelBtn,
      ...
      _vm._l(_vm.fields, function(field, i) {
        return _c("div", { key: field, staticClass: "col s12 m6" }, [
          _c("div", { staticClass: "form-group simple-group" }, [
            _c("label", { attrs: { for: "category_id" + field } }, [
              _vm._v(_vm._s(_vm.label) + " " + _vm._s(field))
            ]),
            _vm._v(" "),
            _c(
              "select",
              ...
              [
                _vm.recipeCategories && _vm.recipeCategories[i]
                  ? _c(
                      "option",
                      {
                        attrs: { selected: "" },
                        domProps: { value: _vm.recipeCategories[i]["id"] }
                      },
                      [
                        _vm._v(
                          "\n                    " +
                            _vm._s(
                              _vm.categories[_vm.recipeCategories[i]["id"] - 1]
                                .name
                            ) +
                            "\n                "
                        )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-81397f68", module.exports)
  }
}
...
Component.options.__file = "resources/js/vue/components/templates/ListItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6924fc6e", Component.options)
  } else {
    hotAPI.reload("data-v-6924fc6e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c(
    ...
    [
      _c(
        "span",
        {
          staticClass: "btn-floating center mr-3 left transparent",
          class: _vm.classNames
        },
        [
          _vm.iconState
            ? _c("span", [_vm._t("icon-on")], 2)
            : _c(
                "i",
                { staticClass: "main-text bold-text" },
                [_vm._t("icon-off")],
                2
              )
        ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6924fc6e", module.exports)
  }
}
...
Component.options.__file = "resources/js/vue/components/SortButtons.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0b701891", Component.options)
  } else {
    hotAPI.reload("data-v-0b701891", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_SortButtons__ = __webpack_require__(192);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_SortButtons__["a" /* default */]],
    ...
    methods: {
        buttonWasClicked: function buttonWasClicked() {
            ...
            Event.$on('hash-changed', function (hash) {
                _this.btns[0].isActive = true;
    ...
    _vm._l(_vm.btns, function(btn) {
      return _c(
        "a",
        {
          ...
          attrs: { href: "/recipes#" + btn.link }
        },
        [
          _c("i", { staticClass: "fas red-text left", class: btn.icon }),
          _vm._v(" "),
          _c("span", { domProps: { textContent: _vm._s(btn.title) } })
        ]
      )
    })
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0b701891", module.exports)
  }
}
...
Component.options.__file = "resources/js/vue/components/Visibility.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ac696b18", Component.options)
  } else {
    hotAPI.reload("data-v-ac696b18", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "resources/js/vue/components/BtnFavs.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-06f5e77c", Component.options)
  } else {
    hotAPI.reload("data-v-06f5e77c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_BtnItem__ = __webpack_require__(24);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_BtnItem__["a" /* default */]]
});
...
var render = function() {
  ...
  return _c("section", [
    _vm.userId
      ? _c(
          "a",
          { staticClass: "p-0 _fav-button", on: { click: _vm.fetchItems } },
          [
            _c("i", {
              staticClass: "fas fa-star fa-15x star",
              class: _vm.iconClass
            }),
            _vm._v(" "),
            _c("span", {
      ...
      : _c(
          "a",
          {
            staticClass: "p-0 tooltipped",
            attrs: { "data-tooltip": _vm.tooltip, "data-position": "bottom" }
          },
          [
            _c("i", { staticClass: "fas fa-star fa-15x star" }),
            _vm._v(" "),
            _c("span", {
              staticClass: "d-inline-block",
              staticStyle: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-06f5e77c", module.exports)
  }
}
...
Component.options.__file = "resources/js/vue/components/BtnLike.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-011948be", Component.options)
  } else {
    hotAPI.reload("data-v-011948be", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("section", { staticClass: "ml-2 d-inline-block" }, [
    _vm.userId
      ? _c(
          "a",
          { staticClass: "p-0 _like-button", on: { click: _vm.fetchItems } },
          [
            _c("i", {
              staticClass: "fas fa-heart fa-15x heart",
              class: _vm.iconClass
            }),
            _vm._v(" "),
            _c("span", {
      ...
      : _c(
          ...
          {
            staticClass: "p-0 tooltipped",
            attrs: { "data-tooltip": _vm.tooltip, "data-position": "right" }
          },
          [
            _c("i", { staticClass: "fas fa-heart fa-15x heart" }),
            _vm._v(" "),
            _c("span", {
              staticClass: "d-inline-block",
              staticStyle: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-011948be", module.exports)
  }
}
...
Component.options.__file = "resources/js/vue/components/Recipes.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6853e99a", Component.options)
  } else {
    hotAPI.reload("data-v-6853e99a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_lazyLoadImagesForVue__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__templates_Preloader__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__templates_Preloader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__templates_Preloader__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchRecipes: function fetchRecipes() {
            ...
            var url = this.url === null ? '/api/recipes/' + hash : this.url;

            Event.$emit("hash-changed", hash);

            this.$axios.get(url).then(function (res) {
                if (res.data.links.next !== null) {
                    _this2.url = res.data.links.next;
                } else {
                    _this2.theEnd = true;
                }

                _this2.recipes = reload ? res.data.data : _this2.recipes.concat(res.data.data);
        ...
        onScroll: function onScroll() {
            var wrap = document.getElementById('recipes-page');
            var contentHeight = wrap.offsetHeight;
            var yOffset = window.pageYOffset;
            var currentPosition = yOffset + window.innerHeight;

            if (currentPosition >= contentHeight && !this.loading) {
                this.fetchRecipes();
            }
        },
        userHasFav: function userHasFav(recipe_id) {
            if (this.favs) {
                var result = this.favs.map(function (fav) {
                    return recipe_id == fav.recipe_id ? "active" : "";
                });
                return result;
            }
        },
        returnFavs: function returnFavs(recipe_id) {
            return this.favs.filter(function (fav) {
                return fav.recipe_id == recipe_id;
            });
        },
        setRandomBgColor: function setRandomBgColor() {
    ...
    components: {
        Preloader: __WEBPACK_IMPORTED_MODULE_1__templates_Preloader___default.a
    }
});
...
Component.options.__file = "resources/js/vue/components/templates/Preloader.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2f79fda4", Component.options)
  } else {
    hotAPI.reload("data-v-2f79fda4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "center py-3 m-auto", class: _vm.className },
    [
      _c("div", { staticClass: "preloader-wrapper active", class: _vm.size }, [
        _vm._m(0)
      ])
    ]
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2f79fda4", module.exports)
  }
}
    ...
    [
      _c(
        ...
        _vm._l(_vm.recipes, function(recipe) {
          return _c("div", { key: recipe.id, staticClass: "col s12 m6 l3" }, [
            _c("div", { staticClass: "card hoverable" }, [
                  ...
                  _c(
                    ...
                    [
                      _c("div", {
                        ...
                        style: { "background-color": _vm.setRandomBgColor() }
                      }),
                      _vm._v(" "),
                      _c("img", {
                        staticClass: "activator lazy-load-img-vue",
                        attrs: {
                        ...
                        on: {
                          load: function($event) {
                            _vm.runLazyLoadImagesForVue($event.target)
                          }
                        }
                      })
                    ]
              ...
              _vm._v(" "),
              _c("div", { staticClass: "card-content min-h" }, [
                _c(
                  "span",
                  {
                ...
                _c("div", { staticStyle: { height: "25%" } }, [
                  _c(
                    ...
                    [
                      _c("btn-favs", {
                        attrs: {
                          "recipe-id": recipe.id,
                          "audio-path": _vm.audioPath,
                          items: _vm.returnFavs(recipe.id),
                          tooltip: _vm.tooltip,
                          "user-id": _vm.userId
                        }
                      })
                  ...
                  _vm._v(" "),
                  _c("span", { staticClass: "left card-time" }, [
                    _c("i", {
                      staticClass:
                        "fas fa-clock fa-1x z-depth-2 main-light circle red-text ml-5 mr-1"
                    }),
                    _vm._v(
                      "\n                            " +
                        _vm._s(recipe.time) +
                  ...
                  _c("i", {
                    staticClass:
                      "fas fa-ellipsis-h right fa-15x red-text activator px-1"
                  })
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "card-reveal" }, [
                ...
                _c(
                  "a",
                  {
                    staticClass: "btn-small mt-3",
                    attrs: { href: "/recipes/" + recipe.slug }
                  },
                  [_vm._v(_vm._s(_vm.go))]
                ),
                _vm._v(" "),
                _c("p", [_vm._v(_vm._s(recipe.intro))])
              ])
            ])
          ])
        })
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", [
      _c("i", { staticClass: "fas fa-times right red-text card-title p-1" })
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6853e99a", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c684b740", Component.options)
  } else {
    hotAPI.reload("data-v-c684b740", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    methods: {
        selectedTab: function selectedTab(_selectedTab) {
            this.tabs.forEach(function (tab) {
                tab.active = tab.name == _selectedTab.name;
            });
        }
    }
});
  ...
  return _c("div", [
    _c(
      ...
      _vm._l(_vm.tabs, function(tab) {
        return _c("li", { key: tab.name, staticClass: "tab" }, [
          _c("a", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c684b740", module.exports)
  }
}
...
Component.options.__file = "resources/js/vue/components/Tab.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0d322123", Component.options)
  } else {
    hotAPI.reload("data-v-0d322123", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0d322123", module.exports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_main__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_main___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__modules_main__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_activeAfterClickBtn__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_navigation__ = __webpack_require__(215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_pages__ = __webpack_require__(216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_recipes__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_settings__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__materialize__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__materialize___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__materialize__);
// Modules
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_activeAfterClickBtn__ = __webpack_require__(13);
...
(function SearchFormActivator() {
    var opened = false;
    var navBtnForSearch = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('nav-btn-for-search');
    var searchInput = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('search-input');

    if (navBtnForSearch) {
        Object(__WEBPACK_IMPORTED_MODULE_2__modules_activeAfterClickBtn__["a" /* default */])('nav-search-form', 'nav-btn-for-search');
...
(function DarkThemeSwitcher() {
    var button = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('dark-theme-toggle');
    var className = document.body.classList;
    var urlWithState = function urlWithState(state) {
        return '/invokes/dark-theme-switcher/' + state;
    };

    button.addEventListener('click', function () {
        if (className.value === 'dark-theme') {
            className.remove('dark-theme');
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(urlWithState(0)).catch(function (e) {
                return console.error(e);
            });
        } else {
            className.add('dark-theme');
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(urlWithState(1)).catch(function (e) {
                return console.error(e);
            });
        }
    });
...
(function MarkNotificationsAsRead() {
    var button = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('mark-notifs-as-read');
    var alertIcon = document.querySelector('#mark-notifs-as-read span');

    if (button && alertIcon) {
        button.addEventListener('click', function () {
            alertIcon.classList.remove('small-notif');

            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put('/invokes/notifications').catch(function (e) {
                return console.error(e);
            });
        });
    }
...
(function HomeHeaderSearchForm() {
    var preventing = true;
    var button = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('home-search-btn');
    var form = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('home-search-form');

    if (form && button) {
        Object(__WEBPACK_IMPORTED_MODULE_1__modules_activeAfterClickBtn__["a" /* default */])('home-search-form', 'home-search-btn');
...
(function runImageUploader() {
    var target = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('target-image');
    var src = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('src-image');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_main__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_main___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__modules_main__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_lazyLoadImages__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_activeAfterClickBtn__ = __webpack_require__(13);
...
(function ReadyCheckbox() {
    var checkbox = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('ready-checkbox');
    var publishBtn = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('publish-btn');
...
(function PopupWindowShowMore() {
    var popupTrigger = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('popup-window-trigger');
    var popupWindow = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('popup-window');

    if (popupTrigger && popupWindow) {
        Object(__WEBPACK_IMPORTED_MODULE_2__modules_activeAfterClickBtn__["a" /* default */])('popup-window', 'popup-window-trigger');
    }
})();

(function IncreaseFontSize() {
    var incFontSizeBtn = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('inc-font-size');
    var dicFontSizeBtn = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('dic-font-size');
    var elements = document.querySelectorAll('.font-scalable');

    if (incFontSizeBtn && dicFontSizeBtn) {
        incFontSizeBtn.addEventListener('click', function () {
            elements.forEach(function (el) {
                var currentSize = parseFloat(el.style.fontSize);
                var newFontSize = currentSize + 0.1;

                if (currentSize <= 1.5 && currentSize >= 0.9) {
                    el.style.fontSize = newFontSize + 'em';
                    __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('/invokes/font-size-switcher/' + newFontSize).catch(function (err) {
                        return console.error(err);
                    });
                }
            });
        ...
        dicFontSizeBtn.addEventListener('click', function () {
            elements.forEach(function (el) {
                var currentSize = parseFloat(el.style.fontSize);
                var newFontSize = currentSize - 0.1;
...
(function HideBlurImageAndShowOriginal() {
    Object(__WEBPACK_IMPORTED_MODULE_1__modules_lazyLoadImages__["a" /* default */])();
})();

(function RemoveEmptyLinesFromTextareaWithLines() {
    var fields = document.querySelectorAll('.textarea-lines');
    var regex = /^\s*[\r\n]/gm;
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function () {
    var images = document.querySelectorAll('img.lazy-load-img');
...
(function CollapsibleNavigationMenu() {
    var li = __WEBPACK_IMPORTED_MODULE_0__modules_main___default()('collapsible-li-tag');
    var body = document.querySelector('#collapsible-li-tag .collapsible-body');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var menu = document.getElementById('adminka-collapsible');
