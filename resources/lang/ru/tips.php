...
return [
    ...
    'rating_tip' => 'Опыт: :value<br>В этом поле указан опыт автора.<br>Опыт составляется с нижеперечисленных данных:<br><br>1 лайк = ' . config('custom.exp_for_like') . ' очков опыта<br>1 просмотр = ' . config('custom.exp_for_like') . ' очков опыта<br>1 опубликованный рецепт = ' . config('custom.exp_for_like') . ' очков опыта',
