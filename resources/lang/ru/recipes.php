...
return [
    ...
    'ingredients_desc' => 'Все ингредиенты рецепта. После каждого ингредиента нажимайте кнопку Ввод (Enter) чтобы разделить их на строки.',
    'text_description' => 'Опишите процесс приготовления блюда по пунктам, используя Ввод (Enter) для отделения пунктов друг от друга.',
    'text_of_recipe' => 'Процесс приготовления',
    'category' => 'Категория',
    'categories' => 'Категории',
    'time' => 'Время приготовления',
    'time_description' => 'Время приготовления в минутах',
    'meal_description' => 'Время приема блюда',
    'image' => 'Изображение',
