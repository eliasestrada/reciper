...
return [
    ...
    'remove_from_favs' => 'Удалить с избранного',
    'loved' => 'Любимые',
    'title' => 'Название',
    ...
    'are_you_sure_to_draft' => 'Нам очень жаль но вы потеряете ' . config('custom.xp_for_approve') . ' очков опыта и рецепт не будет доступен для посетителей после переноса его в черновики. Вы точно хотите поместить этот рецепт в черновики и потерять ' . config('custom.xp_for_approve') . ' очков опыта?',
    ...
    'new_recipe_waiting' => config('app.name') . '. Рецепт на рассмотрении! ',
