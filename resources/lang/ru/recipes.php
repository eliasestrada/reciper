...
return [
    ...
    'text_of_recipe' => 'Содержание рецепта',
    'category' => 'Категория',
    ...
    'are_you_sure_to_draft' => 'Нам очень жаль но вы потеряете ' . config('custom.exp_for_approve') . ' очков опыта и рецепт не будет доступен для посетителей после переноса его в черновики. Вы точно хотите поместить этот рецепт в черновики и потерять ' . config('custom.exp_for_approve') . ' очков?',
