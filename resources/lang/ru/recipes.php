...
return [
    ...
    'are_you_sure_to_draft' => 'Ваш рецепт не будет доступен для посетителей после переноса его в черновики. Вы точно хотите поместить этот рецепт в черновики?',
    'are_you_sure_to_download' => 'Скачать список ингредиентов в текстовом файле?',
