...
return [
    ...
    'delete_account_desc' => 'Для подтверждения удаления страницы, введите ваш текущий пароль и нажмите удалить. Ваша страница будет деактивирована без потери авторства и очищена от всех данных включая опыт и популярность. Вы можете восстановить доступ к странице в любое время без возможности восстановления данных.',
    'are_you_sure_to_deactivate' => 'Нам будет вас не хватать 😢 Вы точно хотите деактивировать страницу и потерять все данные?',
