            ...
            @else
                <div class="no-select">
                    ...
                    <a href="/users/{{ $recipe->approver->id }}" title="@lang('users.go_to_profile')">
                        <img src="{{ asset('storage/small/users/' . $recipe->approver->image) }}" class="circle" style="border:3px solid green" alt="{{ $recipe->approver->name }}" width="50">
                    ...
                    <a href="/users/{{ $recipe->user_id }}" title="@lang('users.go_to_profile')">
                        <img src="{{ asset('storage/small/users/' . $recipe->user->image) }}" class="circle" style="border:3px solid green" alt="{{ $recipe->approver->name }}" width="50">
