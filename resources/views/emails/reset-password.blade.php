                ...
                <table border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse: collapse; border-spacing: 0; padding: 0; width: inherit; max-width: 560px; margin-top: 40px">
                    ...
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%; padding-top: 25px; color: #000000; font-family: sans-serif">
                            @lang('passwords.click_to_reset_pwd')
                        </td>
                    </tr>
                    <!-- Button -->
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; padding-top: 25px; padding-bottom: 5px;">
                            <a href="{{ $token }}" target="_blank" style="text-decoration: none; background: #484074; padding: 10px 15px; border-radius: 4px; color: #eee; font-family: sans-serif">
                                @lang('passwords.reset_pwd')
                            </a>
                        </td>
                    </tr>
