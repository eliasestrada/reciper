    ...
    public function run()
    {
        ...
        Help::insert([
            ...
            [
                ...
                'text_ru' => 'Зарегистрироваться можно по этой ссылке: ' . help_link('reciper.tk/register', '/register') . ', либо в меню навигации нажать на кнопку меню в правом верхнем углу экрана, и из выподающее меню выберите "Регистрация".<br> Заполните форму регистрации и нажмите кнопку <b>Регистрация</b> для завершения процесса.',
            ],
            [
                'id' => 6,
                'help_category_id' => 1,
