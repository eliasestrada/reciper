    ...
    public function run()
    {
        Help::insert([
            ...
            [
                ...
                'text_ru' => 'Изменить фотографию можно в настройках фотографии: <a href="' . \URL::to('/settings/photo/edit') . '">reciper.tk/settings/photo/edit</a>. Либо перейдите в Меню > Настройки > Фотография.',
            ],
            [
                'id' => 3,
                'help_category_id' => 2,
            ...
            [
                ...
                'text_ru' => 'Зарегистрироваться можно по этой ссылке: <a href="' . \URL::to('/register') . '">reciper.tk/register</a>, либо в меню навигации нажать на кнопку Войти <i class="fas fa-sign-in-alt main-text tiny"></i> затем закладку "Регистрация".<br> Заполните форму регистрации и нажмите кнопку <b>Регистрация</b> для завершения процесса.',
            ],
            [
                'id' => 6,
                'help_category_id' => 3,
