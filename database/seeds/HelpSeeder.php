    ...
    public function run()
    {
        ...
        Help::insert([
            ...
            [
                ...
                'help_category_id' => 1,
                'title_ru' => 'Уровни.',
                'text_ru' => '<div class="row"><div class="col s12 m6 l6 pb-3">На старте после регистрации каждый ресипёр имеет первый уровень и один опыта. Для освоения нового уровня ресипёру необходимо набрать определенное количество опыта. Как набирать опыт вы можете прочитать на странице ' . help_link('Опыт и ударный режим.', 8) . '.<br><br>Предел опыта который можно набрать - ' . $xp->levels[10]['max'] . '. Именно на этом количестве опыта ресипёр получает 10-тый уровень, который является максимальным.</div><div class="col s12 m6 l6"><b>Таблица уровней и опыта:</b><br>
