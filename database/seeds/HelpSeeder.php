    ...
    public function run()
    {
        Help::insert([
            ...
            [
                ...
                'text_en' => 'Information about distributing experience points can be seen by hovering over the trophy icon under the profile image on your page.',
            ],
            [
                'id' => 7,
                'help_category_id' => 2,
                'title_ru' => 'Почему любимые рецепты не отображаются на другом устройстве?',
                'text_ru' => 'Все рецепты которым вы подарили сердечко отстаются отмеченными для вас, для того чтобы иметь быстрый доступ к ним в любое время. Все подаренные сердца привязанны к вашему устройству, поэтому при смене устройства вы не обнаружите их в списке <a href="' . \URL::to('/recipes#my_likes') . '">Любимые</a> рецепты. Если это вам составляет неудобство, сообщите нам, отправив нам сообщение <a href="' . \URL::to('/contact') . '"> reciper.tk/contact </a>.',
