...
<div class="image-bg row mb-0">
    <div class="col s12 m6 offset-m3 form-wrapper my-5 frames z-depth-1">
        ...
        <form method="POST" action="{{ route('login') }}" class="px-4">
            ...
            <visibility inline-template>
                <div class="input-field">
                    <input class="validate with-icon"
                        :type="type"
                        name="password"
                        id="password"
                        autocomplete="off"
                        required
                    >
                    <div class="d-inline-block visibility-icon waves-effect waves-green"
            ...
            <a href="{{ route('password.request') }}" class="text text-hover">
                @lang('forms.forgot_pwd')
            </a>
        </form>
    </div>
</div>
