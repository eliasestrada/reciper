        ...
        <div class="col s12 m7 l8 mt-3">
            <div class="row">
                <div class="col s12 l6">
                    ...
                    <p>@lang('settings.choose_photo', [
                        'btn1' => trans('forms.select_file'),
                        'btn2' => trans('forms.save')
                    ])</p>
                    @include('includes.input-error', ['field' => 'photo'])
                </div>

                <div class="col s12 l6">
                    <form action="{{ action('Settings\PhotoController@update') }}"
                        method="post"
                    ...
                    @if (user()->image != 'default.jpg')
                        <form action="{{ action('Settings\PhotoController@destroy') }}"
                            method="post"
                            enctype="multipart/form-data"
                            class="center"
                        >
                            ...
                            <button type="submit"
                                class="d-block mx-auto btn red my-1 min-w hoverable waves-effect waves-light"
                            >
