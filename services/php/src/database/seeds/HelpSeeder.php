    ...
    public function run()
    {
        ...
        Help::insert([
            ...
            [
                ...
                'text_ru' => 'Зарегистрироваться можно по этой ссылке: ' . help_link('reciper.tk/register', '/register') . ', либо в меню навигации нажать на кнопку меню в правом верхнем углу экрана, и из выпадающее меню выберите "Регистрация".<br> Заполните форму регистрации и нажмите кнопку <b>Регистрация</b> для завершения процесса.',
            ],
            [
                'id' => 6,
                'help_category_id' => 1,
                'title_ru' => 'Очки популярности.',
                'text_ru' => 'Очки популярности приобретаются когда ваши публикации нравятся посетителям. За каждое действие в адрес вашей публикации вы получаете очки популярности.<br>Популярность составляется с нижеперечисленных данных:<br><br>1 сердечко = ' . config('custom.popularity_for_like') . ' очков<br>1 просмотр = ' . config('custom.popularity_for_view') . ' очков<br>1 добавление в избранные = ' . config('custom.popularity_for_favs') . ' очко',
            ],
            [
                'id' => 7,
                'help_category_id' => 3,
